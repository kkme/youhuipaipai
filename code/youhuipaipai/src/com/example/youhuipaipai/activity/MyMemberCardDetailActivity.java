...
public class MyMemberCardDetailActivity extends BaseActivity {
    ...
    public void onClick(View v) {
        ...
        case R.id.apply_btn:
            if (TextUtils.isEmpty(userid) || "0".equals(userid)) {
                ToastUtil.showShort(MyMemberCardDetailActivity.this, "请先登录");
                return;
            }
            applyMembercard();
            break;
    ...
    private void getMembercardDetail() {
        ...
        hu.post(this, hm, new CallbackListener() {
            ...
            public void onFailed(FailureResult result) {
                dismissProgressDialog();
                ToastUtil.showShort(MyMemberCardDetailActivity.this,
                        result.message);
            }
        });
    }
    ...
    private void initCardView(boolean setGone) {
        MemberCardView mcv = new MemberCardView(MyMemberCardDetailActivity.this,
                null);
        mcv.setData(mc, true);
    ...
    private void applyMembercard() {
        ...
        hu.post(this, hm, new CallbackListener() {
            ...
            public void onSuccess(JSONObject result) {
                ...
                ToastUtil.showShort(MyMemberCardDetailActivity.this, "申请成功");
            }
