 ...
 * 
 ******************************************/
public class CouponHomeActivity extends BaseActivity implements
        IXListViewListener {
    ...
    protected void initView() {
        ...
        intent=getIntent();
        String nameString=intent.getStringExtra("requestCommand");
        if(null!=nameString){
        	...
        	} else if("RecommendList".equals(nameString)){
        		title.setText("小编推荐");
        	}
        }else{
...
//        	fragment.getView().setVisibility(View.GONE);
        ...
        citycode=MyPreference.getString(CouponHomeActivity.this, "selectAreaId");
        ...
        hu.post(this, hm, new CallbackListener() {
            ...
            public void onSuccess(JSONObject result) {
				...
				if(index==1){
					adapter.clear();
					if(list.size()==0){
						ToastUtil.showShort(CouponHomeActivity.this, getString(R.string.no_data));
					}
				}
				...
				adapter.resetData(list);
					if(lv.mPullRefreshing){
						lv.stopRefresh();
						String timeString=TimeUtil.getNowTime();
						MyPreference.putString(CouponHomeActivity.this, requestCommand+"timeNow", timeString);
					}
					if(lv.mPullLoading){
						lv.stopLoadMore();
					}
...
//						return;
            ...
            public void onFailed(FailureResult result) {
                dismissProgressDialog();
                ToastUtil
                        .showShort(CouponHomeActivity.this, result.message);
            }
        });
    }
    ...
    public void onClick(View v) {
        ...
        case R.id.right_tv:
                    ...
                    if (list.size() == 0) {
                        ToastUtil.showShort(CouponHomeActivity.this, "没有商家");
                        return ;
                    }
