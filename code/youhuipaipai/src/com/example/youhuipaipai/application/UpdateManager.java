...
public class UpdateManager {
    ...
    private boolean isUpdate() {
        ...
        try {
            ...
            data.put("requestCommand", "GetLastVersion");
            data.put("version", "" + versionCode);

            json = new HttpImpl().doPostJSON(Constant.HOST_URL, data)
                    .getString();
        ...
        if (null != mHashMap) {
            ...
            // return true;
            // }
            if ("1".equals(mHashMap.get("version").toString())) {
                return true;
            }
        }
        return false;
    ...
    public void getVersionFromJson(String json) throws JSONException {
        JSONObject object = new JSONObject(json);
        String version = object.optString("result");
        String url = object.optString("message");
        // String name = data.optString("name");
        if (!url.contains("http")) {
            url = Constant.HOST_URL + url;
        }
        mHashMap = new HashMap<String, String>();
        mHashMap.put("version", version);
        mHashMap.put("url", url);
        mHashMap.put("name", "优惠拍拍");
    }
    ...
    private int getVersionCode(Context context) {
        ...
        try {
            ...
            versionCode = context.getPackageManager().getPackageInfo(
                    "com.example.youhuipaipai", 0).versionCode;
