...
public class MyMerchantAdapter extends AdapterBase<Merchant> {
    ...
    public MyMerchantAdapter(List<Merchant> entities, Context c) {
        if (entities == null) {
            this.entities = new ArrayList<Merchant>();
        } else {
            this.entities = entities;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(
                    R.layout.myshop_listview_item, null);
