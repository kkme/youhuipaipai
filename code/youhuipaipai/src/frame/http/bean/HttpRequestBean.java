...
public class HttpRequestBean {
	...
	public void connect(IHttpCallBack callBack, int callBackID,IThreadManage iThreadManage){
		connect(callBack, callBackID, false, iThreadManage, null);
	}
	 
	public void connect(IHttpCallBack callBack, int callBackID,IThreadManage iThreadManage,String threadKey){
		connect(callBack, callBackID, false, iThreadManage, threadKey);
	}
	
	public void connect(IHttpCallBack callBack, int callBackID, boolean isTest,IThreadManage iThreadManage,String threadKey){
